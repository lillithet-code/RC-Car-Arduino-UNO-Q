...
PAYMENTS_BASE_URL="$(resolve_config_value PAYMENTS_BASE_URL 'https://drive.kbob.org')"
STRIPE_SECRET_KEY="$(resolve_config_value STRIPE_SECRET_KEY '')"
STRIPE_WEBHOOK_SECRET="$(resolve_config_value STRIPE_WEBHOOK_SECRET '')"
ACCOUNT_BASE_URL="$(resolve_config_value ACCOUNT_BASE_URL 'https://drive.kbob.org')"
SMTP_HOST="$(resolve_config_value SMTP_HOST '')"
SMTP_PORT="$(resolve_config_value SMTP_PORT '587')"
SMTP_USERNAME="$(resolve_config_value SMTP_USERNAME '')"
SMTP_PASSWORD="$(resolve_config_value SMTP_PASSWORD '')"
SMTP_FROM="$(resolve_config_value SMTP_FROM '')"
SMTP_SECURITY="$(resolve_config_value SMTP_SECURITY 'starttls')"
