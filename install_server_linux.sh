...
PAYPAL_CLIENT_ID="$(resolve_config_value PAYPAL_CLIENT_ID '')"
PAYPAL_CLIENT_SECRET="$(resolve_config_value PAYPAL_CLIENT_SECRET '')"
PAYPAL_WEBHOOK_ID="$(resolve_config_value PAYPAL_WEBHOOK_ID '')"
PAYPAL_ENVIRONMENT="$(resolve_config_value PAYPAL_ENVIRONMENT 'sandbox')"
