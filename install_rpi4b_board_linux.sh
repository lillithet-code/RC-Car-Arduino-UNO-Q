...
STREAM_IDLE_POLL_SECONDS="$(resolve_config_value STREAM_IDLE_POLL_SECONDS 2.0)"
...
CPU_GOVERNOR_CONTROL_ENABLED="$(resolve_config_value CPU_GOVERNOR_CONTROL_ENABLED 1)"
CPU_GOVERNOR_ACTIVE="$(resolve_config_value CPU_GOVERNOR_ACTIVE ondemand)"
CPU_GOVERNOR_IDLE="$(resolve_config_value CPU_GOVERNOR_IDLE powersave)"
DISABLE_BLUETOOTH="$(resolve_config_value DISABLE_BLUETOOTH 1)"
DISABLE_HDMI="$(resolve_config_value DISABLE_HDMI 1)"
...
DRIVE_IN1_PIN="$(resolve_config_value DRIVE_IN1_PIN 12)"
DRIVE_IN2_PIN="$(resolve_config_value DRIVE_IN2_PIN 13)"
FORWARD_THROTTLE="$(resolve_config_value FORWARD_THROTTLE 0.65)"
BACK_THROTTLE="$(resolve_config_value BACK_THROTTLE 0.5)"
MOTOR_ACCELERATION_SECONDS="$(resolve_config_value MOTOR_ACCELERATION_SECONDS 5.0)"
SERVO_PIN="$(resolve_config_value SERVO_PIN 6)"
...
LIGHTS_PIN="$(resolve_config_value LIGHTS_PIN 5)"
...
CPU_GOVERNOR_CONTROL_ENABLED=$CPU_GOVERNOR_CONTROL_ENABLED
CPU_GOVERNOR_ACTIVE=$CPU_GOVERNOR_ACTIVE
CPU_GOVERNOR_IDLE=$CPU_GOVERNOR_IDLE
...
MOTOR_ACCELERATION_SECONDS=$MOTOR_ACCELERATION_SECONDS
SERVO_PIN=$SERVO_PIN
