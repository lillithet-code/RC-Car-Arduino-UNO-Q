...
VIDEO_WIDTH="${VIDEO_WIDTH:-1024}"
VIDEO_HEIGHT="${VIDEO_HEIGHT:-576}"
...
H264_UPLOAD_MIN_FLUSH_BYTES="${H264_UPLOAD_MIN_FLUSH_BYTES:-16384}"
H264_UPLOAD_MAX_DELAY_MS="${H264_UPLOAD_MAX_DELAY_MS:-120}"
