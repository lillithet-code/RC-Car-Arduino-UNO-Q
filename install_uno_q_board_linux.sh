...
FRAME_RATE="$(resolve_video_config_value FRAME_RATE 25)"
VIDEO_WIDTH="$(resolve_video_config_value VIDEO_WIDTH 1280)"
VIDEO_HEIGHT="$(resolve_video_config_value VIDEO_HEIGHT 720)"
